...
Rectangle {
    ...
    signal detectedButtonClicked()

    id: tranferShiftWithErrorDetectRect
    color: "#8d222222"
    radius: 2
    border.width: 1
    ...
    RoundButton {
        ...
        background: Rectangle{
            ...
            Image {
                ...
                anchors.left: parent.left
                source: "../../images/page_images/workerDetectedErrorPage/detectErrorAtTranferTime.svg"
        ...
        onClicked: {
            se_btnClicked.play()
            tranferShiftWithErrorDetectRect.detectedButtonClicked()
        }
        ...
        Label {
            ...
            x: 58
            y: 37
            text: qsTr("Giao ca phát hiện lỗi")
