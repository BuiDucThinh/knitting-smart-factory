            ...
            contentItem: Rectangle {
                ...
                Rectangle {
                    ...
                    Row{
                        ...
                        Label {
                            font.pointSize: 16
                            text: qsTr("Bạn có chắc chắn muốn sửa loại mộc - xếp cam ")
                            color: "#2b2b2b" //"#34aadc"
                        ...
                        Label {
                            font.bold: true
                            font.pointSize: 16
                            text: qsTr(lv_fabricType.model.get(lv_fabricType.currentIndex).text_)
                            color: "#2b2b2b" //"#34aadc"
                    ...
                    Row{
                        ...
                        Label {
                            font.bold: true
                            font.pointSize: 16
                            text: qsTr(tf_editFabricType.text.toUpperCase())
                            color: "#2b2b2b" //"#34aadc"
...
//                    }
                ...
                Row {
                    ...
                    Button {
                        ...
                        onClicked: {
                            fabricPageBridge.editFabricType(lv_fabricType.model.get(lv_fabricType.currentIndex).index_
